  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>moCODE - Privacy Policy</title>
        <meta
          name="description"
        ...
        <main className="policy">
          <div className="container policy-content">
            <div className="section-header policy-header">
              ...
              <h1 className="section-title policy-title">Privacy Policy</h1>
              <p className="section-description">
                This policy explains how moCODE collects, uses, and protects
                information.
              </p>
            ...
            <section className="policy-section">
              ...
              <p>
                This privacy policy applies to the moCode app (hereby referred
                to as "Application") for mobile devices that was created by
                Oridinity (hereby referred to as "Service Provider") as a
            ...
            <section className="policy-section">
              ...
              <p>
                ...
                to email,userId. The information that the Service Provider
            ...
            <section className="policy-section">
              ...
              <p>
                ...
                vaibhav@ordinity.com and they will respond in a reasonable time.
              </p>
            </section>
            ...
            <section className="policy-section">
              ...
              <p>
                ...
                In the case the Service Provider discover that a child under 13
                ...
                (vaibhav@ordinity.com) so that they will be able to take the
                necessary actions.
              </p>
            </section>
            ...
            <section className="policy-section">
              ...
              <p>This privacy policy is effective as of 2026-02-16</p>
            </section>
