  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>moCODE - Terms &amp; Conditions</title>
        <meta
          name="description"
      ...
      <body>
        ...
        <main className="policy">
          <div className="container policy-content">
            <div className="section-header policy-header">
              ...
              <h1 className="section-title policy-title">Terms &amp; Conditions</h1>
              <p className="section-description">
                Please read these terms carefully before using moCODE.
              </p>
              <p className="policy-meta">Effective date: 2026-02-16</p>
            </div>

            <section className="policy-section">
              <h2>Terms &amp; Conditions</h2>
              <p>
                These terms and conditions apply to the moCode app (hereby
                referred to as "Application") for mobile devices that was
                created by Oridinity (hereby referred to as "Service Provider")
              ...
              <p>
                ...
                such, they reserve the right to modify the Application or charge
                for their services at any time and for any reason. The Service
            ...
            <section className="policy-section">
              ...
              <p>
                ...
                Provider ensures that all AI usage complies with applicable
            ...
            <section className="policy-section">
              ...
              <p>These terms and conditions are effective as of 2026-02-16</p>
            </section>
            ...
            <section className="policy-section" id="contact">
              ...
              <p>
                ...
                Provider at vaibhav@ordinity.com.
              </p>
            </section>
        ...
        <footer className="footer">
          <div className="container footer-content">
            <p className="footer-text">© 2024 moCODE. Built for developers.</p>
...
export async function renderTermsPage() {
  const stream = await renderToReadableStream(<TermsPage />);
